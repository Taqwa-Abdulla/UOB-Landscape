...
$botKnowledge = [
    ...
    fulfillment of SDGs. Read more here: <br><br><button class=\"option-btn\"><a href=\"/web%20pages/about.html\">About</a></button>",
    
    "who is aspen?" => "I am Aspen, your chatbot assistant. I help you navigate the website and answer your questions.",
     
    "campus map" => "You can find our interactive landscape campus map by clicking on: <br><br>
    <button class=\"option-btn\"><a href=\"/web%20pages/uob_3d_map.html\">Map</a></button>",
    ...
    each plant in the campus, and search and filter results. <a href=\"/web%20pages/locations.html\">Locations</a>",
    ...
    You can discover campus plants by: <br><br><button class=\"option-btn\"><a href=\"/web%20pages/plants/indoor.html\">Indoor plants</a></button>
     and <button class=\"option-btn\"><a href=\"/web%20pages/plants/outdoor.html\">Outdoor plants</a></button>",
    ...
    <button class=\"option-btn\"><a href=\"/web%20pages/projects/statistics%20and%20reports.html\">Stats</a></button>",
    
    "improvements" => "You can have a look at recent improvements with a view of before and after by visiting <br><br>
    <button class=\"option-btn\"><a href=\"/web%20pages/projects/before%20and%20after.html\">Improvements</a></button>",
...
elseif (isset($botKnowledge[$lowerMessage])) {
    $response = $botKnowledge[$lowerMessage];
} 
else {
    $response = "I couldn't find an exact match for that. What else I can help you with? <br><br>📞 Phone: +973 1715 5355<br>📧 Email: <button class=\"option-btn\"><a href=\"mailto:support@uob.edu.bh\"></a>support@uob.edu.bh</button>";
}
