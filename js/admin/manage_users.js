...
const API_URL = "/api/admin/users_management.php";
...
function renderTable(data) {
  ...
  data.forEach(user => {
    ...
    const subLabelValue = user.major || 'N/A';
...
async function handleFormSubmit(event) {
  ...
  const payload = {
    ...
    major: dynamicFieldInput ? dynamicFieldInput.value.trim() || null : null,
